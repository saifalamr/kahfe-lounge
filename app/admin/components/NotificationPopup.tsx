          ...
          <div key={order.id} style={{ padding: '16px 18px', borderBottom: '1px solid #2A2A2A' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: 8, borderTop: '1px solid rgba(201,168,76,.2)' }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <button onClick={() => onDismiss(order.id)} style={{ background: 'transparent', border: '1px solid #383838', borderRadius: 8, height: 40, padding: '0 14px', color: '#8A8A8A', fontSize: 13, cursor: 'pointer', fontWeight: 600, fontFamily: "'IBM Plex Sans', sans-serif" }}>Kapat</button>
